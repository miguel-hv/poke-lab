...
Tengo [esta misma aplicación en React](https://github.com/miguel-hv/pokelabv2), usando Material y Redux.

## Testing
Añado tests end to end (en este caso integración) con [Cypress](https://docs.cypress.io/guides/getting-started/opening-the-app) siguiendo [este tutorial](https://www.youtube.com/watch?v=spe8XqNL5RA).
...
Uso signals para la gestión de pokemon, secretos y usuario según la explicada [en este artículo](https://blog.angulartraining.com/tutorial-state-management-with-observable-store-services-5ba53d87ad94) con observables y adaptada a signals en vez de observables de acuerdo a lo establecido en el [siguiente artículo](https://blog.angulartraining.com/angular-signal-based-components-tutorial-4e4b4b1dfa96).
...
### Clases componentes
Estoy cogiendo algunos estilos de codepen como el [input](https://codepen.io/amankriet/pen/dyEXNQZ) o el [button](https://codepen.io/ericadamski/pen/ZBxavq). Estilar o componentizar este tipo de elementos no es algo que forme parte de este proyecto, así que no están bien pulidos.
