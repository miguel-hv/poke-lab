...
## Manejo de estado: NgRx y NgRx signals
...
´´´
En la rama main se tiene la versión con NgRx Signals:
´´´
...
´´´
En esta rama (ngrxStore) se tiene la versión de gestión del estado con el store basado en actions y reducers
